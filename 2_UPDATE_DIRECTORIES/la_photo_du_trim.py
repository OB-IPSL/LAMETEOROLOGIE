...
selection='La photo du trimestre'

f = open('output/la_photo_du_trim.html', 'w')
f.write('<meta http-equiv="Content-Type" content="text/html; charset=utf-8">'+'\n')
f.write('<H1>La photo du trimestre</H1><P>'+'\n')
...
for file in files:
  ...
  for notice in notices: 
     ...
     if rubrique_print == selection:
       ...
       f.write("<A HREF="+url_print+">La photo du trimestre du numéro ")
       f.write(num_print+"</A><BR>"+'\n') 
       nb=nb+1

print(nb,' photos trouves')
