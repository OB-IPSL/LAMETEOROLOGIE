...
selection1='Vient de paraître'
selection2='Vient de Paraître'

f = open('output/vdp.html', 'w')
f.write('<meta http-equiv="Content-Type" content="text/html; charset=utf-8">'+'\n')
f.write('<H1>Vient de paraître</H1><P>'+'\n')
...
for file in files:
  ...
  for notice in notices: 
     ...
     if rubrique_print == selection1 or rubrique_print == selection2:
       ...
       f.write("<A HREF="+url_print+">"+titre_print+" "+num_print+"</A><P>"+'\n') 
       nb=nb+1

print(nb,' vdp trouves')
